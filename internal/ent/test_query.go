...
import (
	...
	"github.com/chetan0402/desync/internal/ent/test"
)
...
func (tq *TestQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (tq *TestQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(test.Table, test.Columns, sqlgraph.NewFieldSpec(test.FieldID, field.TypeString))
	_spec.From = tq.sql
