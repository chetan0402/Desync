...
func (tc *TestCreate) sqlSave(ctx context.Context) (*Test, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected Test.ID type: %T", _spec.ID.Value)
		}
	}
...
func (tc *TestCreate) createSpec() (*Test, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(test.Table, sqlgraph.NewFieldSpec(test.FieldID, field.TypeString))
	)
